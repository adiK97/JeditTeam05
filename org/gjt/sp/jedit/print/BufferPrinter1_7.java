...
public class BufferPrinter1_7
{
	...
	private static final String PRINT_ERROR_TITLE = "print-error.title";
	private static final String PRINT_ERROR_MESSAGE = "print-error.message";
	...
	public static void print( final View view, final Buffer buffer )
	{
		...
		if ( printService != null )
		{
			...
			{
				e.printStackTrace();
				JOptionPane.showMessageDialog( view, jEdit.getProperty( PRINT_ERROR_MESSAGE, new String[] {e.getMessage()} ), jEdit.getProperty( PRINT_ERROR_TITLE ), JOptionPane.ERROR_MESSAGE );
				return;
			}
		}
		else
		{
			JOptionPane.showMessageDialog( view, jEdit.getProperty( PRINT_ERROR_MESSAGE, new String[] {"Invalid print service."} ), jEdit.getProperty( PRINT_ERROR_TITLE ), JOptionPane.ERROR_MESSAGE );
			return;
		}
	...
	protected static void printPage( PrintPreviewModel model )
	{
		...
		if ( printService != null )
		{
			...
			{
				JOptionPane.showMessageDialog( model.getView(), jEdit.getProperty( PRINT_ERROR_MESSAGE, new String[] {e.getMessage()} ), jEdit.getProperty( PRINT_ERROR_TITLE ), JOptionPane.ERROR_MESSAGE );
				return;
			}
		}
		else
		{
			JOptionPane.showMessageDialog( model.getView(), jEdit.getProperty( PRINT_ERROR_MESSAGE, new String[] {"Invalid print service."} ), jEdit.getProperty( PRINT_ERROR_TITLE ), JOptionPane.ERROR_MESSAGE );
			return;
		}
